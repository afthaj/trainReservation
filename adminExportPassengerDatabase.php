...
<title>Export Passenger Database | TrainReserve Admin</title>
  ...
  <div class="bodyContainer">
    ...
    <div class="mainContentContainer">
	 ...
	 <div class="mainContent">
      <h2>Export Passenger Database</h2>
     </div>
     <div class="mainContent">
     This will export the entire Passenger table into an XML file that is stored in the root folder of the server as <a href="passengers.xml">passengers.xml</a>
     </div>
       <div class="mainContent">
      <p>
	  <?php
		  ...
		  if (isset($_POST['submit'])) {
					  $xml = simplexml_load_file("passengers.xml");
					  ...
					  if ($row != NULL) {
						  ...
						  $trainst->addChild("passengerID", "$passengerID");
      ...
      <form action="<?php echo $_SERVER['PHP_SELF'] ?>" method="post" name="adminExportPassengerDatabase" id="adminExportPassengerDatabase">
