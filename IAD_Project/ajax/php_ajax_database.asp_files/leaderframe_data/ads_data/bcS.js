...
{if(adRequestData.width>0&&adRequestData.height>0&&adRequestData.width<=1000&&adRequestData.height<=1000&&adRequestData.placement>0)
{var newWinStr=adRequestData.landInNewWindow?"&newWin=1":"";var placementStr="&re="+fEsc(adRequestData.placement+"");var siteIDStr=adRequestData.externalSiteID===null||adRequestData.externalSiteID===undefined?"":("&ug="+fEsc(adRequestData.externalSiteID));var isPreviewStr="&pv="+(adRequestData.isPreview?adRequestData.isPreview:"0");var bidData=(adRequestData.bidData===null||adRequestData.bidData===undefined)?"":adRequestData.bidData;var bidDataArray=bidData.split(";");var bidDataStr="";if(bidDataArray.length===7){var j=0;var paramAndValue;for(j=0;j<6;j++){paramAndValue=bidDataArray[j].split("=");if(paramAndValue.length===2){if(paramAndValue[0]==="creativeOptimization")
bidDataStr+="&co=";else if(paramAndValue[0]==="price")
...
dd.writeln("<ifr"+"ame src=\""+rfiURLPrefix()+window._rfiAServer+"/sed?w="+adRequestData.width+"&h="+adRequestData.height+newWinStr+placementStr+siteIDStr+isPreviewStr+"&"+
